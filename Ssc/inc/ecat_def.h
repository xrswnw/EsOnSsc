...
#define COMPLETE_ACCESS_SUPPORTED                 0 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define SEGMENTED_SDO_SUPPORTED                   0 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#define SDO_RES_INTERFACE                         0 //This define was already evaluated by ET9300 Project Handler(V. 1.4.1.0)!
#endif
...
#ifndef VENDOR_ID
#define VENDOR_ID                                 0xA1AA1107
#endif

/** 
PRODUCT_CODE: Object 0x1018 SI2 (EtherCAT product code) */
#ifndef PRODUCT_CODE
#define PRODUCT_CODE                              0xA0030320
#endif
...
#define MIN_PD_WRITE_ADDRESS                      0x1400
#endif
...
#define MAX_PD_WRITE_ADDRESS                      0x17FF
#endif
...
#define MIN_PD_READ_ADDRESS                       0x1800
#endif
...
#define MAX_PD_READ_ADDRESS                       0x1BFF
#endif
